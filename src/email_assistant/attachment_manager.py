...
class AttachmentStats(BaseModel):
    ...
    oldestFile: datetime | None = None
    newestFile: datetime | None = None
...
class AttachmentManager:
    ...
    def get_attachment_path(
        self, message_id: str, filename: str, date: datetime | None = None
    ) -> Path:
        """
    ...
    def save_attachment(
        self, message_id: str, filename: str, content: bytes, date: datetime | None = None
    ) -> dict[str, Any]:
        """
    ...
    def get_attachment(self, message_id: str, filename: str) -> bytes | None:
        """
    ...
    def _find_by_hash(self, sha256_hash: str) -> Path | None:
    ...
    def _search_hash_in_date_dir(self, date_dir: Path, target_hash: str) -> Path | None:
    ...
    def _search_hash_in_message_dir(self, message_dir: Path, target_hash: str) -> Path | None:
