            ...
            "rules": [
                ...
                },
                {
                    ...
                    "conditions": [
                        ...
                        {"field": "subject", "operator": "regex", "value": "(urgent|asap|important)"}
                    ],
                    "actions": [
                        {"type": "flag", "parameters": {"color": "red"}}
                    ]
                }
            ]
        }
...
def test_scheduler():
    ...
    for schedule in schedules:
        response = requests.get(
            f"{API_BASE}/scheduler/preview",
            params={"schedule": schedule, "count": 3}
        )
...
def test_graph():
    ...
    response = requests.get(
        ...
        params={"q": "SELECT * WHERE { ?s ?p ?o } LIMIT 10"}
    )
