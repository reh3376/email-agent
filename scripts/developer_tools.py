...
def create_branch(username: str, feature: str):
    ...
    print(f"2. Commit with descriptive messages (>15 words)")
    print(f"3. Push with: git push -u origin {branch_name}")
    print(f"4. Create PR at: https://github.com/reh3376/email-agent/pulls")
...
def check_pr_ready():
    ...
    # Run linting check
    result = subprocess.run(['uv', 'run', 'python', 'scripts/check_linting.py'], capture_output=True)
